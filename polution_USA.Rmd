...
# Filtrer les données pour une ville spécifique (par exemple, New York)
...
components_values <- c(5, 10, 20, 30)
...
ggplot() +
  geom_line(data = new_york_data, aes(x = Date.Local, y = variable_to_smooth), color = "black") +
